...
`r fontawesome::fa_i("hand-point-right")` &nbsp;Deux catégories :
...
`r fontawesome::fa_i("hand-point-right")` &nbsp;Un objet spatial se représente
dans l'espace selon un référentiel spatial : le **système de coordonnées** (**CRS** pour _Coordinates Reference System_)

`r fontawesome::fa_i("hand-point-right")` &nbsp;Deux types de systèmes de coordonnées existent  :
...
`r fontawesome::fa_i("hand-point-right")` &nbsp;Le choix du CRS peut être crucial et dépend souvent de l'information que l'on souhaite représenter
...
Sous `r fontawesome::fa_i("r-project")` le CRS s'exprime selon le standard `proj4string` défini par le projet [**PROJ**](https://proj.org/)
...
`r fontawesome::fa_i("hand-point-right")` &nbsp;Où trouver le bon CRS ? Réponse : [**Spatial Reference**](https://spatialreference.org/)
...
## Les packages `r fontawesome::fa_i("r-project")` - Vecteurs
...
`r fontawesome::fa_i("hand-point-right")` &nbsp;`{sf}` est devenu la "norme" : `{sf} = {sp} + {rgdal} + {rgeos}`
...
- Implémentation sous `r fontawesome::fa_i("r-project")` des _Simple Features_
...
`r fontawesome::fa_i("hand-point-right")` &nbsp;Edzer Pebesma le recommende `r emo::ji("smile")`
...
`r fontawesome::fa_i("hand-point-right")` &nbsp;Quid des lignes et polygones ?

`r fontawesome::fa_i("hand-point-right")` &nbsp;Voir les fonctions `st_linestring()` et `st_polygon()`
...
```{r echo=FALSE, eval=TRUE, message=FALSE}
(prefectures <- readr::read_csv(here::here("data", "occitanie_prefectures.csv")))
```
...
```{r "map1", echo=FALSE, eval=TRUE, fig.width=10, dpi=300, fig.height=5, out.width="100%", fig.path="chunks/"}
library("ggplot2")
ggplot(data = world) +
  geom_sf() +
...
```{r echo=TRUE, eval=FALSE, fig.width=10, dpi=300, fig.height=5, out.width="100%", fig.path="chunks/"}
ggplot(data = world) +
  geom_sf() +
  xlab("Longitude") + ylab("Latitude") + ggtitle("Carte du monde")
```
...
```{r "map2", echo=FALSE, eval=TRUE, fig.width=10, dpi=300, fig.height=5, out.width="100%", fig.path="chunks/"}
ggplot(data = world) +
...
```{r "map3", echo=FALSE, eval=TRUE, fig.width=10, dpi=300, fig.height=5, out.width="100%", fig.path="chunks/"}
ggplot(data = world) +
  geom_sf(fill = "#49847b", colour = "#e1ddc0") +
  xlab("Longitude") + ylab("Latitude") + ggtitle("Carte du monde") +
...
sf::st_layers(here::here("data", "occitanie.shp"))
```
...
```{r echo=FALSE, eval=TRUE}
occitanie <- sf::st_read(
  dsn = here::here("data"),
  layer = "occitanie", quiet = TRUE)
```
```
...
```{r "map4", echo=FALSE, eval=TRUE, fig.align="center", fig.width=8, dpi=300, fig.height=7, out.width="70%", fig.path="chunks/"}
...
```{r "map5", echo=FALSE, eval=TRUE, fig.align="center", fig.width=8, dpi=300, fig.height=7, out.width="70%", fig.path="chunks/"}
ggplot(data = occitanie) +
  geom_sf(fill = "#49847b", colour = "#e1ddc0") +
  xlab("Longitude") + ylab("Latitude") + ggtitle("OCCITANIE") +
...
```{r "map6", echo=FALSE, eval=TRUE, fig.align="center", fig.width=8, dpi=300, fig.height=7, out.width="70%", fig.path="chunks/", warning=FALSE}
ggplot(data = occitanie) +
  geom_sf(fill = "#49847b", colour = "#e1ddc0") +
  xlab("Longitude") + ylab("Latitude") + ggtitle("OCCITANIE") +
  geom_sf(data = prefectures, colour = "#3f3f3f") +
...
```{r "map7", echo=FALSE, eval=TRUE, fig.align="center", fig.width=8, dpi=300, fig.height=7, out.width="70%", fig.path="chunks/", warning=FALSE}
ggplot(data = occitanie) +
  geom_sf(fill = "#49847b", colour = "#e1ddc0") +
  xlab("Longitude") + ylab("Latitude") + ggtitle("OCCITANIE") +
  geom_sf(data = prefectures, colour = "#3f3f3f") +
...
```{r "map9", echo=FALSE, eval=TRUE, fig.align="center", fig.width=6, dpi=300, fig.height=6, out.width="60%", fig.path="chunks/", warning=FALSE}
...
```{r "map10", echo=FALSE, eval=TRUE, fig.align="center", fig.width=6, dpi=300, fig.height=6, out.width="60%", fig.path="chunks/", warning=FALSE}
ggplot(data = world) +
  geom_sf(fill = "#49847b", colour = "#e1ddc0") +
  coord_sf(crs = prj) +
  theme(panel.border = element_blank())
...
```{r "map11", echo=FALSE, eval=TRUE, fig.align="center", fig.width=6, fig.height=6, out.width="100%", fig.path="chunks/", warning=FALSE}
...
```{r "map12", echo=FALSE, eval=TRUE, fig.align="center", fig.width=6, fig.height=6, out.width="100%", fig.path="chunks/", warning=FALSE}
